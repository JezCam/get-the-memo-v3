...
import { Settings01, RefreshCw01 } from '@untitled-ui/icons-react'
        ...
        <Card className="w-full h-full p-3 bg-card flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
                ...
                >
                    <Label
                        htmlFor="r1"
                        className={`hover:cursor-pointer bg-primary/10 rounded-sm py-3 flex-1 flex justify-center border-[1px] ${selection === Selection.Corners && 'border-primary'}`}
                    >
                    ...
                    <Label
                        htmlFor="r2"
                        className={`hover:cursor-pointer bg-primary/10 rounded-sm py-3 flex-1 flex justify-center border-[1px] ${selection === Selection.Edges && 'border-primary border-[1px]'}`}
                    >
                        <div className="flex items-center space-x-2">
                            <RadioGroupItem
                                className="child"
                    ...
                    <Label
                        htmlFor="r3"
                        className={`hover:cursor-pointer bg-primary/10 rounded-sm py-3 flex-1 flex justify-center border-[1px] ${selection === Selection.Both && 'border-primary border-[1px]'}`}
                    >
                        <div className="flex items-center space-x-2">
                ...
                <div className="flex bg-primary/10 rounded-sm p-3 gap-3 h-fit">
                    {[0, 0, 0, 0, 0, 0].map((_, index) => (
                        <div
                            ...
                            className="border-primary border-2 w-full aspect-square h-auto hover:opacity-60 rounded-sm hover:cursor-pointer"
                        />
                    ))}

                    <div className="bg-gradient-to-b from-primary/10 to-primary/0 flex items-center justify-center border-primary/50 border-2 w-full aspect-square h-auto hover:bg-primary/20 rounded-sm hover:cursor-pointer">
                        ...
                        {[0, 0, 0, 0, 0, 0, 0, 0, 0].map((_, index) =>
                            index != 4 ? (
                                <div
                                    ...
                                    className="border-primary border-2 w-full h-full flex items-center justify-center p-6 rounded-sm"
                                >
                                    <Input
                                        value={
                                            letters[
                                ...
                                >
                                    <div
                                        ...
                                        className={
                                            colour === 5
                                                ? 'bg-gradient-to-b from-black/10 to-black/0 flex items-center justify-center border-black/50 border-2 w-full h-full hover:bg-black/20 rounded-sm hover:cursor-pointer'
                                                : 'bg-gradient-to-b from-primary/10 to-primary/0 flex items-center justify-center border-primary/50 border-2 w-full h-full hover:bg-primary/20 rounded-sm hover:cursor-pointer'
                                        }
                                    >
                                        <RefreshCw01
                                            className={
